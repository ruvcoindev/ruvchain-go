// Package address contains the types used by ruvchain to represent IPv6 addresses or prefixes, as well as functions for working with these types.
...
// GetPrefix returns the address prefix used by ruvchain.
