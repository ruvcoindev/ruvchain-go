...
int main(int argc, char **argv) {
	...
	if (argc != 2) {
		fprintf(stderr, "usage: ./ruvchain-brute-multi-curve25519 <seconds>\n");
		return 1;
	}
	...
	fprintf(stderr, "Searching for ruvchain curve25519 keys (this will take slightly longer than %ld seconds)\n", requestedtime);
